...
/**
 * BoundedStreamTextTests
 *
 * @author Aaric, created on 2022-08-24T14:18.
 * @version 0.1.0-SNAPSHOT
 */
public class BoundedStreamTextTests {

    @Test
    public void testCount() throws Exception {
        // DataStream API
        StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();
        DataStreamSource<String> dss = env.readTextFile("input/sample.txt");
